...
<body>
  ...
  <div id="content">
    <div class="container">
      ...
      <div class="row">
        <div class="col-6">
        <embed src="http://localhost/cv_builders/print.php" type="application/pdf" style="height: 80vh; width: 800px">
          <!-- <embed src="http://localhost/cv_builders/print.php" frameborder="0" style="height: 80vh; width:800px"></em> -->
        </div>
